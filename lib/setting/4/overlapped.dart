...
import 'package:overlapped_carousel/card.dart';


class OverlappedCarousel1 extends StatefulWidget {
  ...
  @override
  _OverlappedCarousel1State createState() => _OverlappedCarousel1State();
}

class _OverlappedCarousel1State extends State<OverlappedCarousel1> {
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          return GestureDetector(
            ...
            child: OverlappedCarousel1CardItems(
              cards: List.generate(
...
class OverlappedCarousel1CardItems extends StatelessWidget {
